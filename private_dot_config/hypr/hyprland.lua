...
hl.bind(mainMod .. " + Q", hl.dsp.exec_cmd("xournalpp"))
...
hl.bind(mainMod .. " + grave", hl.dsp.focus({ workspace = "name:~" }))
...
hl.window_rule({
    ...
    float = true,
    move = {
        "max(0, min(cursor_x-(window_w*0.5), monitor_w - window_w))",
        "max(0, min(cursor_y-(window_h*0.5), monitor_h - window_h))",
    },
    size = { "800", "600" },
})
